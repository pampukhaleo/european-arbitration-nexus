const ru = {
  seo: {
    home: {
      title: "Европейская Арбитражная Палата | Эффективное разрешение коммерческих споров.",
      description: "Международная неприбыльная ассоциация «Европейская арбитражная палата» (ЕАП) была основана в Бельгии в 2008 году по инициативе профессионалов в сфере коммерческого арбитража и медиации из Бельгии, Франции и Украины."
    },
    eac: {
    ...
    council: {
      ...
      description: "Познакомьтесь с профессионалами, входящими в состав совета Европейской Арбитражной Палаты."
    },
    news: {
      title: "Новости и обновления | Европейская Арбитражная Палата",
      description: "Следите за последними новостями, мероприятиями и разработками в ЕАП."
    },
    icac: {
      title: "О МКАС при ЕАП | Европейская Арбитражная Палата",
      description: "Международный коммерческий арбитражный суд при Европейской Арбитражной Палате (далее - «МКАС при ЕАП») – независимый постоянно действующий арбитражный суд, который осуществляет свою деятельность в соответствии с Судебным кодексом Бельгии (ст.1676-1722), Уставом Европейской Арбитражной Палаты и собственным Регламентом."
    },
    rules: {
      title: "РЕГЛАМЕНТ МКАС ПРИ ЕАП | Европейская Арбитражная Палата",
    ...
    fees: {
      title: "Положение о Сборах | Европейская Арбитражная Палата",
    ...
    calculator: {
      title: "Калькулятор Стоимости | Европейская Арбитражная Палата",
    ...
    clause: {
      title: "Типовая арбитражная оговорка МКАС при ЕАП | Европейская Арбитражная Палата",
      description: "Типовая арбитражная оговорка для включения в международные контракты."
    },
    icje: {
      title: "Экспертиза в МЦСЭ | Европейская Арбитражная Палата",
      description: "При Европейской Арбитражной Палате, как отдельный департамент, функционирует Международный центр судебной и ADR экспертизы при ЕАП (МЦСЭ), который осуществляет свою деятельность в соответствии с Уставом Европейской Арбитражной Палаты."
    },
    areas: {
      title: "ОСНОВНЫЕ НАПРАВЛЕНИЯ ЭКСПЕРТНЫХ ИССЛЕДОВАНИЙ МЦСЭ | Европейская Арбитражная Палата",
      description: "Международный центр судебной и ADR экспертизы (МЦЭС) предоставляет широкий спектр экспертных исследований и экспертных услуг в различных отраслях, включая такие экспертизы, как:"
    },
    authentication: {
      title: "Аутентификация произведений искусства | Европейская Арбитражная Палата",
      description: "Определение подлинности произведений искусства имеет решающее значение для коллекционеров, инвесторов, музеев и галерей. Международный центр судебной и ADR экспертизы (МЦСЭ) при Европейской Арбитражной Палате предоставляет профессиональные услуги по аутентификации произведений искусства для проверки их оригинальности, установления авторства и провенанса."
    },
    appraisal: {
      title: "ОЦЕНКА СТОИМОСТИ ПРОИЗВЕДЕНИЙ ИСКУССТВА | Европейская Арбитражная Палата",
      description: "Для определения рыночной стоимости произведений искусства проводится всесторонняя экспертиза и оценка."
    },
    artPassport: {
      title: "АВТОРИЗАЦИЯ ПРОИЗВЕДЕНИЙ ИСКУССТВА | Европейская Арбитражная Палата",
      description: "Эксперты Международного центра судебной и ADR экспертизы при Европейской Aрбитражной Палате оказывают услуги по авторизации и сертификации произведений искусства. Результатом этого процесса является выдача паспорта на произведение искусства, удостоверяющего его уникальные физические характеристики и особенности."
    },
    benefits: {
      title: "5 ПРИЧИН ОФОРМИТЬ ЧЛЕНСТВО В ЕАП | Европейская Арбитражная Палата",
      description: "Аккредитация арбитра. Карьерные возможноcти. Повышение профессиональной квалификации. Обмен профессиональной информацией в сфере международного права и арбитража. Рекламные возможности."
    },
    join: {
    ...
    conductCode: {
      title: "Кодекс корпоративной этики | Европейская Арбитражная Палата",
      description: "Европейская арбитражная палата утвердила настоящий Кодекс корпоративной этики для применения и строго соблюдения ее членами."
    },
    contacts: {
      title: "Связаться с нами | Европейская Арбитражная Палата",
      description: "Свяжитесь с Европейской Арбитражной Палатой по любым вопросам или для получения поддержки."
    },
    about: {
      title: "О нас | Европейская Арбитражная Палата",
      description: "Узнайте о миссии, видении и ценностях Европейской Арбитражной Палаты."
    }
  },
  language: {
    english: 'EN',
  ...
  aboutEAC: {
    ...
    keyAreas: {
      ...
      judicial: "Судебная Экспертиза – проведение экспертных ��ценок для судебных и арбитражных разбирательств.",
  ...
  arbitration: {
    icac: {
      ...
      features: {
        ...
        principlesDesc: "МКАС при ЕАП рассматривает стандарты независимости, беспристрас��ности и добросовестности как первостепенные и решающие свойства для надлежащего функционирования МКАС.",
  ...
  expertise: {
    ...
    fields: {
      ...
      providedFor: [
        ...
        "В соответствии с другими юридическими �� процессуальными нормами."
      ],
