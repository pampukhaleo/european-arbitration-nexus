const ru = {
  ...
  artExpertise: {
    ...
    appraisal: {
      ...
      intro1: "Для определения рыночной стоимост�� произведений искусства проводится всесторонняя экспертиза и оценка.",
