...
export default {
  seo: {
    ...
    icje: {
      title: "Экспертиза в МЦЭ | Европейская Арбитражная Палата",
      description: "При Европейской Арбитражной Палате, как отдельный департамент, функционирует Международный центр экспертизы при Европейской Арбитражной Палате (МЦЭ при ЕАП), который осуществляет свою деятельность в соответствии с Уставом Европейской Арбитражной Палаты."
    },
    areas: {
      title: "ОСНОВНЫЕ НАПРАВЛЕНИЯ ЭКСПЕРТНЫХ ИССЛЕДОВАНИЙ МЦЭ | Европейская Арбитражная Палата",
      description: "Международный центр экспертизы при Европейской Арбитражной Палате (МЦЭ при ЕАП) предоставляет широкий спектр экспертных исследований и экспертных услуг в различных отраслях, включая такие экспертизы, как:"
    },
    authentication: {
      title: "Аутентификация произведений искусства | Европейская Арбитражная Палата",
      description: "Определение подлинности произведений искусства имеет решающее значение для коллекционеров, инвесторов, музеев и галерей. Международный центр экспертизы при Европейской Арбитражной Палате (МЦЭ при ЕАП) при Европейской Арбитражной Палате предоставляет профессиональные услуги по аутентификации произведений искусства для проверки их оригинальности, установления авторства и провенанса."
    },
    appraisal: {
