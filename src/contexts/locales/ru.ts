const ru = {
  ...
  artExpertise: {
    ...
    passport: {
      ...
      intro: "Специалисты Международного центра судебной и ADR экспертизы при Европейской Арбитражной Палате (Брюссель, Бельгия) предоставляют услуги по проведению авторизации и паспортизации предметов искусства, результатом которых является изготовление паспорта произведения искусства, удостоверяющий его подлинность и аутентичность.",
      eligibleObjectsTitle: "Объектом авторизации и паспортизации могут быть:",
      eligibleObjects: [
        ...
        "сборники произведений, сборники обработок фольклора, энциклопедии и антологии, другие составные произведения при условии, что они являются результатом творческого труда по подбору, координации или упорядочению содержания без нарушения авторских прав на произведения, входящие в них как составные части;",
        "музыкальные инструменты;",
        "объекты нумизматики;",
        "антиквариат и другие произведения."
      ],
      certificationTitle: "Что такое паспортизация объектов искусства?",
      ...
      passportContentTitle: "Сведения, содержащиеся в паспорте произведения искусства",
      passportContentIntro: "В паспорте содержатся следующие сведения о произведении искусства:",
      passportFields: [
        "фото произведения искусства;",
        "название произведения искусства;",
        "имя автора и год создания;",
        "размеры;",
        "техника исполнения и материалы."
      ],
      whyImportantTitle: "Почему важна авторизация и паспортизация произведения искусства?",
      whyImportantIntro: "Главное преимущество наличия паспорта произведения искусства – это возможность:",
      advantages: [
        "представлять произведение искусства (картину, скульптуру, керамику и т.д.) на иностранных арт-рынках;",
        "предоставлять произведение искусства для участия в международных арт-выставках и экспозициях;",
        "проверить подлинность произведения искусства при его возвращении владельцу после участия в выставке;",
        "упростить процедуру страхования произведения искусства и минимизировать страховые риски;",
        "оформить куплю-продажу произведения искусства без необходимости проведения дополнительных исследований  по установлению подлинности и аутентичности."
      ],
      finalNote: "Благодаря эксклюзивной методике проведения авторизации произведений искусства конфиденциальные идентификационные данные об объекте авторизации хранятся в дата-центре МЦСЭ при ЕАП и при необходимости специалисты по запросу владельца объекта могут провести аутентификацию произведения искусства и выдать соответствующий сертификат о его соответствии и подлинности."
    }
  },
  membership: {
    benefits: {
