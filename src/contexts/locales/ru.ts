...
export default {
  ...
  fraud: {
    bannerText: "Осторожно: мошенники рассылают поддельные письма и требования оплаты от имени EAC/ICAC.",
    bannerCta: "Как защитить себя",
    menuLabel: "Осторожно, мошенники",
    page: {
      title: "Осторожно, мошенники",
      intro: "Секретариат Европейской арбитражной палаты (EAC) сообщает о случаях мошеннических писем, электронных сообщений и документов, которые ложно выдаются за исходящие от EAC или Международного коммерческого арбитражного суда при EAC (ICAC) либо связанные с ними. Такие сообщения, как правило, направлены на получение денег или персональных данных получателя.",
      officialHeading: "Как отличить настоящее сообщение EAC",
      officialItems: [
        "Официальные адреса электронной почты всегда находятся в домене @chea-taic.be. Любой другой домен (Gmail, Outlook, Yandex, Proton, похожие по написанию домены) — не EAC.",
        "У каждого реального дела есть номер, присвоенный Секретариатом ICAC. Его всегда можно попросить нас подтвердить.",
        "Официальный почтовый адрес: Avenue Louise 146, 1050 Брюссель, Бельгия. Официальный телефон: +32 2 808 77 54.",
        "EAC никогда не просит перечислять деньги на личные банковские счета или на физических лиц.",
      ],
      redFlagsHeading: "Признаки мошенничества",
      redFlagsItems: [
        "Отправитель использует бесплатный почтовый ящик (Gmail, Outlook, Yahoo, Proton, Yandex) или домен, лишь похожий на chea-taic.be.",
        "Уведомление о якобы вынесенном арбитражном решении, лотерее или наследстве, о которых вы не знали.",
        "Срочное требование оплаты, угрозы санкциями или очень короткие сроки для давления на вас.",
        "Просьбы прислать скан паспорта, банковские реквизиты или внести предоплату, чтобы «разблокировать» средства.",
        "Подозрительные вложения (.zip, .exe, документы с макросами) или сокращённые ссылки.",
      ],
      whatToDoHeading: "Что делать при получении подозрительного письма",
      whatToDoItems: [
        "Не отвечайте, не открывайте вложения, не переходите по ссылкам.",
        "Не переводите деньги и не передавайте персональные или банковские данные.",
        "Перешлите письмо целиком (с заголовками) на secretary@chea-taic.be для проверки подлинности.",
        "Если вы уже понесли финансовый ущерб — незамедлительно обратитесь в местную полицию и в свой банк.",
      ],
      enforcementHeading: "Действия EAC",
      enforcementText: "Европейская арбитражная палата сообщила о случаях мошенничества в компетентные правоохранительные органы, включая уголовную полицию. Мы продолжаем сотрудничать с ними и информировать общественность.",
      contactCta: "Связаться с Секретариатом",
    },
  }
};
