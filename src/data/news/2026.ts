...
export const news2026: NewsItem[] = [
  {
    ...
    description: {
      ...
      fr:
        "Le 7 avril 2026, l'Assemblée générale des membres de la Chambre Européenne d'Arbitrage (CEA) s'est tenue à Bruxelles, réunissant des représentants de la communauté professionnelle des arbitres internationaux et des experts de Belgique, d'Allemagne, d'Italie, d'Ukraine, de la République Tchèque, de Lituanie, d'Azerbaïdjan et de Turquie.\n\n" +
      ...
      ru:
        "7 апреля 2026 года в Брюсселе состоялось Общее собрание членов Европейской Арбитражной Палаты (ЕАП), объединившее представителей профессионального сообщества международных арбитров и экспертов из Бельгии, Германии, Италии, Украины, Чехии, Литвы, Азербайджана и Турции.\n\n" +
